...
class DecoderRNN(nn.Module):
    def __init__(self, input_size, augmented_size, hidden_size, output_size):
        ...
        self.cnn = nn.Conv1d(self.input_size, self.augmented_size, kernel_size=1)
        self.lstm_1 = nn.LSTM(self.augmented_size, self.hidden_size)
    ...
    def forward(self, input, ch_1, ch_2, ch_3, ch_4, ch_5, ch_6, ch_7):
        (hidden_1, cell_1), (hidden_2, cell_2), (hidden_3, cell_3), (hidden_4, cell_4), (
        hidden_5, cell_5) = ch_1, ch_2, ch_3, ch_4, ch_5
        (hidden_6, cell_6), (hidden_7, cell_7) = ch_6, ch_7

        output = self.cnn(input.view(1,-1,1))

        output, (hidden_1, cell_1) = self.lstm_1(output.view(1, 1, -1).float(), (hidden_1, cell_1))
        output_1 = output
        ...
        return output, (hidden_1, cell_1), (hidden_2, cell_2), (hidden_3, cell_3), (hidden_4, cell_4), (
        hidden_5, cell_5), (hidden_6, cell_6), (hidden_7, cell_7)
...
def train(input_tensor, target_tensor, decoder, decoder_optimizer, criterion, verbose=False, penalty=(1, 0.5)):
    ...
    for di in range(0, target_length):
        decoder_output, (hidden_1, cell_1), (hidden_2, cell_2), (hidden_3, cell_3), (hidden_4, cell_4), (
        hidden_5, cell_5), (hidden_6, cell_6), (hidden_7, cell_7) = decoder(decoder_input,
                                                                            (hidden_1, cell_1), (hidden_2, cell_2),
                                                                            (hidden_3, cell_3), (hidden_4, cell_4),
                                                                            (hidden_5, cell_5), (hidden_6, cell_6),
                                                                            (hidden_7, cell_7))
        if verbose:
...
def trainIters(decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01, total_batch=maximum_target,
    ...
    for iter in range(1, n_iters + 1):
        ...
        if iter % print_every == 0:
            ...
            torch.save(decoder.state_dict(), 'lstm_smooth_train_withCNN{}.pt'.format(iter/total_batch))
...
trainIters(decoder, 100000, print_every=1000, learning_rate=1e-2, total_batch=15000, gamma=0.2)
