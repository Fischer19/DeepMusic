...
def trainIters(decoder, n_iters, print_every = 1000, plot_every = 100, learning_rate = 0.01, total_batch = maximum_target, penalty = (1, 0.5), gamma = 0.1):    
    ...
    for iter in range(1, n_iters + 1):
        ...
        if iter % total_batch == 0:
            torch.save(decoder.state_dict(), 'lstm_9l_smooth_dim3_CNN{}.pt'.format(iter//total_batch))
...
trainIters(decoder, 200000, print_every=1000, learning_rate=1e-2, penalty= (1, 0.5), gamma = 0.1)
