...
class DecoderRNN(nn.Module):
    def __init__(self, input_size, augmented_size, hidden_size, output_size):
        ...
        self.cnn = nn.Conv1d(self.input_size, self.augmented_size, 1)
...
def trainIters(decoder, n_iters, print_every = 1000, plot_every = 100, learning_rate = 0.01, total_batch = maximum_target, penalty = (1, 0.5), gamma = 0.1):    
    ...
    for iter in range(1, n_iters + 1):
        ...
        if iter % print_every == 0:
            acc, one_acc = validate(decoder, train_X[30000:31000], train_Y[30000:31000])
        ...
        if iter % total_batch == 0:
            torch.save(decoder.state_dict(), 'lstm_9l_smooth_train_CNN{}.pt'.format(iter//total_batch))
...
trainIters(decoder, 150000, print_every=1000, learning_rate=1e-2, total_batch = 30000, penalty= (1, 0.5), gamma = 0.2)
