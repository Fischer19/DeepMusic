...
validator = CrossValidator(model, data, compute_acc=compute_acc, loss_function=nn.CrossEntropyLoss(weight=w), decoder=decode, lr=1e-3, epochs=300)
...
import pickle
f=open('unet_val_crossentropy_nonaug.pk', 'wb')
