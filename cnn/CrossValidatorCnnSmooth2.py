...
validator = CrossValidator(model, data, compute_acc=compute_acc, loss_function=compute_loss, decoder=decode, lr=1e-4, epochs=50, batch_size=100)
...
import pickle
f=open('unet_val_smooth_augmented.pk', 'wb')
